...
class ArticleEconomyTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ArticleEconomyCell", for: indexPath) as! ArticleTVCell
        ...
        if (articles[indexPath.row].urlToImage != nil) {
            ...
            cell.imageArticle.image = UIImage(named: "mindprober")
        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "EconomyToDetail", sender: articles[indexPath.row])
    }
    ...
    */
    ...
    func getArticles(){
        ...
        if let url = URL(string: "https://newsapi.org/v2/everything?q=economy&apiKey=42834204e8f44cd2a9ad854f85bcac19"){
