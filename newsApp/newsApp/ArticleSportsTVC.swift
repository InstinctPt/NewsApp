...
class ArticleSportsTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "SportsToDetail", sender: articles[indexPath.row])
    }
    ...
    */
    ...
    func getArticles(){
        ...
        if let url = URL(string: "https://newsapi.org/v2/everything?q=sports&apiKey=42834204e8f44cd2a9ad854f85bcac19"){
